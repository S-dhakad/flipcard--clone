                ...
                <div className="row g-0">
                  ...
                  >
                    <div className="card-body border-0 ">
                      ...
                      <div className="availableroffer">Available offers</div>
                      <div>
                        ...
                        <div>
                          ...
                          Flipkart Gift Card worth upto ₹1000*Know More
                        </div>
                        <div>
                          <span className="imagrhandler">
                            <img src="\assest\bankoffer.webp" />{" "}
                          </span>{" "}
                          No cost EMI ₹4,667/month. Standard EMI also available{" "}
                        </div>
                      </div>
                      <p className="">
                      ...
                      <div className="Description">
                        ...
                        <div className="Descriptioninformation">
                          ...
                          seamless performance with the Redmi Note 11 SE, which
                          is packed with a number of exceptional features. The
                          Helio G95 HyperEngine Game Technology, which powers
                          this phone, enables spectacular gameplay and
                          outstanding graphic quality. Also offering
                          stutter-free streaming and fluid navigation is its
                          16.33 cm (6.42) Super AMOLED display. Moreover, the 64
                          MP quad-camera setup and 13 MP selfie camera on this
                          smartphone provide speedy image processing while
                          capturing stunning landscapes all around you.
                        </div>
                      </div>
                    </div>
                  </div>
